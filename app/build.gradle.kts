...
android {
    ...
    buildTypes {
        debug {
            ...
            buildConfigField("String", "BASE_URL", "\"https://pulsebackend-git-main-darielsevillas-projects.vercel.app\"")
            ...
            buildConfigField("String", "VITALS_URL", "\"https://pulsebackend-git-main-darielsevillas-projects.vercel.app/vitals\"")
